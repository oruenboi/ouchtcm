...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Updated color palette based on new colors
        primary: {
          DEFAULT: '#735344', // Brown
          light: '#8A6553',
          dark: '#5D4237',
        },
        secondary: {
          DEFAULT: '#00CABA', // Electric Teal
          light: '#00E6D5',
          dark: '#00A89A',
        },
        accent: {
          DEFAULT: '#F07522', // Orange
          light: '#F5923F',
          dark: '#D86A1B',
        },
        // Brown/taupe from the speech bubble outline
        taupe: {
          DEFAULT: '#796451', 
          light: '#9A8573',
          dark: '#5A4A3E',
