          ...
          >
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none">
              ...
              {activeRelationships.map(rel => {
                ...
                // Skip this relationship if either element is not found
            ...
            <div className="animate-fadeIn">
              {elements
                ...
                .map(el => (
                  <div
                    key={el.id}
                    className={`p-4 rounded-lg h-full border ${el.borderColor}`}
                  >
                    <h3 className={`text-lg font-semibold ${el.textColor}`}>
                      {el.name} Element
                    </h3>
                          ...
                          .map((r, i) => {
                            ...
                            return (
                              <li key={i} className="flex items-center">
                                <span
                                  className={`w-3 h-3 rounded-full mr-2 ${other.color}`}
                                />
                                {isFrom
