          ...
          >
            ...
            {elements.map((el) => (
              <div
                ...
                onKeyPress={(e) =>
                  e.key === 'Enter' && handleElementClick(el.id)
                }
                className={classNames(
                  ...
                  activeElement &&
                    activeElement !== el.id &&
                    !isRelationshipActive(activeElement, el.id)
                    ? 'opacity-40'
                    : 'opacity-100'
                )}
                style={{
          ...
          {activeElement ? (
                  ...
                  <div className="mt-6">
                    ...
                    <ul className="text-sm space-y-2">
                      {relationships.generation
                        .filter(
                          (r) => r.from === el.id || r.to === el.id
                        )
                        .map((r, i) => {
                          const other = elements.find(
                            (o) =>
                              o.id ===
                              (r.from === el.id ? r.to : r.from)
                          )!;
                          ...
                          return (
                            <li key={i} className="flex items-center">
                              ...
                              {isFrom ? (
                                <>
                                  <strong
                                    className={el.textColor}
                                  >
                                    {el.name}
                                  </strong>{' '}
                                  nourishes{' '}
                                  <strong
                                    className={other.textColor}
                                  >
                                    {other.name}
                                  </strong>
                                </>
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-700 mb-4">
                The Five Elements describe how energy flows in nature
                and the body, with each element representing a
                system of organs, emotions, and more.
              </p>
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-700 text-sm">
                <li>
                  <strong>Generation Cycle:</strong> Each element
                  nourishes the next in sequence.
                </li>
                <li>
                  <strong>Control Cycle:</strong> Each element keeps
                  another in check.
                </li>
              </ul>
              <p className="text-gray-700 mt-4 text-sm italic">
                Click an element above to view its details, or use
                the buttons to animate each cycle.
              </p>
            </div>
          )}
        </div>
